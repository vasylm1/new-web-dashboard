translations = {
    "English": {
        ...
        "aboutTitle": "About Me",
        "aboutText1": "I’m an experienced marketing professional with a solid background in office administration, technical support, and product marketing. I hold a Bachelor’s degree in Marketing and am currently pursuing a Master’s in Marketing Management, as well as postgraduate studies in Digital Transformation in Germany",
"aboutText2": "I lead and support product launches, manage marketing asset development, managing product portfolio and drive content quality improvements using tools like Power BI, Excel, SAP, and Power Platform. My approach combines strategic thinking with data-driven execution to deliver measurable marketing impact.",
"aboutText3": "I’m fluent in Ukrainian, Russian, Polish, English, and German, and currently expanding my skills in Spanish and Chinese. I like to work in international, cross-functional environments and value clear communication and collaboration.",
"aboutText4": "Outside of work, I’m passionate about travel, technology, continuous learning, and organizing events. I’m always looking for ways to innovate, grow, and contribute at a higher level.",
...
"fileconv_error": "Error during conversion:"
    ...
    "Polski": {
        ...
        "aboutTitle": "O mnie",
        "aboutText1": "Jestem doświadczonym specjalistą ds. marketingu z solidnym doświadczeniem w administracji biurowej, wsparciu technicznym i marketingu produktowym. Posiadam tytuł licencjata z marketingu i obecnie studiuję marketing menedżerski na studiach magisterskich, a także uczestniczę w studiach podyplomowych z zakresu transformacji cyfrowej w Niemczech.",
"aboutText2": "Prowadzę i wspieram wdrażanie nowych produktów, tworzę materiały marketingowe, zarządzam portfelem produktów oraz poprawiam jakość treści, korzystając z narzędzi takich jak Power BI, Excel, SAP i Power Platform. Moje podejście łączy myślenie strategiczne z działaniem opartym na danych, aby osiągać wymierne efekty marketingowe.",
"aboutText3": "Mówię biegle po ukraińsku, rosyjsku, polsku, angielsku i niemiecku, a obecnie rozwijam swoje umiejętności językowe w zakresie hiszpańskiego i chińskiego. Lubię pracować w międzynarodowym i międzyfunkcyjnym środowisku oraz cenię sobie jasną komunikację i współpracę.",
"aboutText4": "Poza pracą pasjonuję się podróżami, technologią, ciągłym uczeniem się i organizacją wydarzeń. Zawsze szukam sposobów na wprowadzanie innowacji, rozwój i działania na wyższym poziomie.",
...
"fileconv_error": "Błąd podczas konwersji:"
    ...
    "Deutsch": {
        ...
        "aboutText1": "Ich bin ein erfahrener Marketingprofi mit fundiertem Hintergrund in Büroorganisation, technischer Unterstützung und Produktmarketing. Ich habe einen Bachelor-Abschluss in Marketing und studiere derzeit im Masterstudiengang Marketing Management sowie in einem postgradualen Studiengang für Digitale Transformation in Deutschland.",
"aboutText2": "Ich leite und unterstütze Produkteinführungen, entwickle Marketingmaterialien, verwalte das Produktportfolio und verbessere die Inhaltsqualität mit Tools wie Power BI, Excel, SAP und Power Platform. Mein Ansatz kombiniert strategisches Denken mit datenbasierter Umsetzung, um messbare Marketingergebnisse zu erzielen.",
"aboutText3": "Ich spreche fließend Ukrainisch, Russisch, Polnisch, Englisch und Deutsch und erweitere derzeit meine Sprachkenntnisse in Spanisch und Chinesisch. Ich arbeite gerne in internationalen, funktionsübergreifenden Umgebungen und lege großen Wert auf klare Kommunikation und Zusammenarbeit.",
"aboutText4": "Außerhalb der Arbeit begeistere ich mich für Reisen, Technologie, lebenslanges Lernen und die Organisation von Veranstaltungen. Ich bin stets auf der Suche nach Möglichkeiten, zu innovieren, zu wachsen und auf höherem Niveau beizutragen.",
...
"fileconv_error": "Fehler bei der Konvertierung:"
    ...
    "Українська": {
        ...
        "aboutTitle": "Про мене",
        "aboutText1": "Я — досвідчений фахівець з маркетингу з ґрунтовним досвідом в офісному адмініструванні, технічній підтримці та продуктовому маркетингу. Маю ступінь бакалавра з маркетингу та наразі навчаюся на магістратурі за спеціальністю «Управління маркетингом», а також проходжу післядипломне навчання з цифрової трансформації в Німеччині.",
"aboutText2": "Я керую та підтримую запуск нових продуктів, займаюсь розробкою маркетингових матеріалів, управлінням продуктовим портфелем та покращенням якості контенту, використовуючи такі інструменти, як Power BI, Excel, SAP і Power Platform. Мій підхід поєднує стратегічне мислення з аналітичним підходом для досягнення вимірюваних маркетингових результатів.",
"aboutText3": "Вільно володію українською, російською, польською, англійською та німецькою мовами, і наразі розширюю свої знання іспанської та китайської. Мені подобається працювати в міжнародному та міжфункціональному середовищі й я ціную чітку комунікацію та співпрацю.",
"aboutText4": "Поза роботою я захоплююсь подорожами, технологіями, безперервним навчанням та організацією подій. Я завжди шукаю способи впроваджувати інновації, розвиватися та робити внесок на вищому рівні.",
...
"fileconv_error": "Помилка під час конвертації:"
    ...
    "中文": {
        ...
        "selectTool": "请选择工具：",
        "aboutTitle": "关于我",
       "aboutText1": "我是一位经验丰富的市场营销专业人士，拥有办公室管理、技术支持和产品营销方面的扎实背景。我拥有市场营销学士学位，目前正在攻读市场营销管理硕士学位，并在德国进行数字化转型的研究生学习。",
"aboutText2": "我负责领导和支持产品发布，管理营销资产开发、产品组合管理，并利用 Power BI、Excel、SAP 和 Power Platform 等工具提升内容质量。我的方法将战略思维与数据驱动的执行相结合，以实现可衡量的营销成果。",
"aboutText3": "我能流利使用乌克兰语、俄语、波兰语、英语和德语，目前正在学习西班牙语和中文。我喜欢在国际和跨职能的环境中工作，并重视清晰的沟通与协作。",
"aboutText4": "工作之外，我热爱旅行、科技、持续学习和组织活动。我始终在寻找创新、成长和在更高层次做出贡献的机会。",
